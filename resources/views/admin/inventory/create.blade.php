<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Crear Nuevo Item de Inventario') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('inventory.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="quantity" name="quantity" type="number" step="0.01" class="mt-1 block w-full" required />
                            <x-input-error class="mt-2" :messages="$errors->get('quantity')" />
                        </div>

                        <div>
                            <x-input-label for="alert_threshold" value="Umbral de Alerta" />
                            <x-text-input id="alert_threshold" name="alert_threshold" type="number" step="0.01" class="mt-1 block w-full" required />
